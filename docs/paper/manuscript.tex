...
FedSI~\cite{zhang2023fedsi} & General Non-IID Proxies & Synaptic Intelligence & None (FedAvg) & Simulation & [Compression Ratio Focus] & Not Reported$^*$ \\
...
This paper presented FL-CL, an end-to-end framework for decentralized, continuous cyber defense on encrypted network flows without raw payload inspection. Systematic empirical evaluation across five production research tracks on a physical 3-node Proxmox VE hypervisor cluster yields three principal findings:
