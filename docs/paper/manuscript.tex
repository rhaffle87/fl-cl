...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig12_system_architecture.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{fig13_cl_strategy_flow.png}
...
\begin{table*}[t]
\caption{Empirical Performance Summary of the 72-Run Subsystem Matrix Sweep on the Physical Proxmox VE Cluster}
...
\toprule
\textbf{Subsystem Dimension} & \textbf{Evaluated Variant} & \textbf{Mean Acc.} & \textbf{Peak Acc.} & \textbf{INT8 Size} & \textbf{Comm./Rnd} \\
\midrule
\multirow{3}{*}{\textbf{Neural Backbone}} 
 & \textbf{1D-CNN} & \textbf{92.39\%} & \textbf{99.20\%} & \textbf{46.4 KB} & 185.8 KB \\
 & \textbf{MLP} & 92.38\% & 98.45\% & \textbf{19.8 KB} & \textbf{79.4 KB} \\
 & \textbf{Transformer} & 90.11\% & \textbf{99.55\%} & 74.2 KB & 299.6 KB \\
\midrule
\multirow{3}{*}{\textbf{Continual Learning}} 
 & \textbf{A-GEM ($p{=}128$)} & \textbf{92.38\%} & 99.16\% & --- & --- \\
 & \textbf{GEM ($p{=}128$)} & \textbf{94.53\%} & \textbf{99.55\%} & --- & --- \\
 & \textbf{EWC ($\lambda{=}0.8$)} & 87.71\% & 99.11\% & --- & --- \\
\midrule
\multirow{4}{*}{\textbf{Federated Aggregator}} 
 & \textbf{TrimmedMean ($\beta{=}0.1$)} & \textbf{94.61\%} & \textbf{99.55\%} & --- & --- \\
 & \textbf{FedAvg} & 95.55\% & 99.11\% & --- & --- \\
 & \textbf{Krum ($f{=}1$)} & 95.43\% & 99.08\% & --- & --- \\
 & \textbf{FedMedian} & 80.52\% & 99.30\% & --- & --- \\
\midrule
\multirow{2}{*}{\textbf{Differential Privacy}} 
 & \textbf{DP Disabled ($\sigma{=}0.00$)} & 91.62\% & 99.11\% & --- & --- \\
 & \textbf{DP Enabled ($\sigma{=}0.30$)} & \textbf{91.43\%} & \textbf{99.55\%} & --- & --- \\
\bottomrule
\end{tabular*}
\end{table*}
...
\caption{Empirical Pareto Frontier: Threat classification accuracy (\%) versus communication payload per round (KB) and INT8 quantized footprint across evaluated backbones.}
\label{fig:pareto}
\end{figure}
