...
| **`generate_`** | Artifact & Report Generation | Generates publication figures, LaTeX PDF manuscripts, and Ollama LLM threat intelligence summaries. | `generate_paper_figures.py`, `generate_paper_pdf.py`, `generate_llm_report.py` |
