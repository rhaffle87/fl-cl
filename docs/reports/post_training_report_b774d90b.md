...
| **Communication Overhead** | `294,480 bytes/round` |
...
- **Candidate**: Version `v16` — BWT gate **FAILED** (Class 1 BWT = −0.2081)
- **Champion**: Version `v15` retained as production champion
- **Action Required**: Manual review for deployment-specific BWT tolerance

## Visualization Plots

### Training History (Loss & Accuracy)

![Loss & Accuracy](plots/loss_accuracy_curves.png)

### Per-Class F1 Trend

![Per-Class F1](plots/f1_class_trends.png)

### Catastrophic Forgetting Analysis

![Forgetting Curves](plots/forgetting_curves.png)

### Cross-Run Comparison (CPI)

![Cross-Run Comparison](plots/run_comparison_chart.png)

## Related Documents

- [Full Training Results Report](training_results_report.md)
- [Parameter Sweep Report](parameter_sweep_report.md)
