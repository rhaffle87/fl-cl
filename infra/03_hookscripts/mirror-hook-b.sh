#!/bin/bash
# =============================================================================
# mirror-hook-b.sh — Port Mirroring: Target B1 (VM 201) → Defender B (VM 200)
# =============================================================================
# Deploy to:  /var/lib/vz/snippets/mirror-hook-b.sh  on Node 'node2'
# Bind with:  qm set 201 --hookscript local:snippets/mirror-hook-b.sh
# =============================================================================
...
SOURCE="tap201i0"   # Target B1's net0 on vmbr1
MIRROR="tap200i1"   # Defender B's net1 (capture) on vmbr1
